...
def upgrade(name: str = "") -> None:
    ...
    op.create_table('command_record',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table('killmail_condition_subscription',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table('killmail_high_value_subscription',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('platform', sa.String(), nullable=False),
    sa.Column('bot_id', sa.String(), nullable=False),
    sa.Column('session_id', sa.String(), nullable=False),
    ...
    op.create_table('killmail_push_record',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
