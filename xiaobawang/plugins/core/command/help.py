        ...
        },
        {
            ...
            "items": [
                ...
                },
                {
                    ...
                    "hot": False,
                    "commands": [
                        "/sub <add/remove> <type> <name>",
                        "[-a value] [-v value]"
                    ],
                    "desc": "订阅高价值KM,可以使用[value]设置最低推送阈值 -a:最后一击,-v:损失，默认30m。目前支持[char,corp,alliance,ship,system]"
                },
                {
                    "title": "订阅高价值KM",
                    "new": False,
            ...
            "items": [
                {
                    ...
                    "commands": [
                        "/jita item_name",
                        "/jita item_name*quantity",
                        "Reply to message + /next"
                    ],
                    "desc": "When many items are found, they will be displayed in groups of three, and you can reply to paginate. Item groups will show total group price."
                },
                {
                    ...
                    "desc": "Translate EVE specific terms, use --limit to limit the number of translations. Currently only supports Chinese-English translation."
                },
                {
            ...
            "items": [
                {
                    ...
                    "desc": "Query zkb statistics, you can use -t [type] to query specific type of information. Currently only supports corporation, character"
                },
                {
                    ...
                    "desc": "Subscribe to killmails, use [value] to set minimum threshold -a: final blow, -v: loss, default 30m. Currently supports [char,corp,alliance,ship,system]"
                },
                {
    ...
    await help.finish(
        UniMessage.image(
            raw=await render_template(
                template_path=templates_path / "help",
